    ...
    var renderRoomStatus = (function() {
      ...
      $.post( "/getAllRoomStatus", function( data ) {
        ...
        roomStatus.forEach(function(element){
         ...
         myhtml = myhtml + '<div class="row justify-content-center">'+
        '                    <div class="col-lg-6">'+
        '                        <div class="card">'+
        '                            <div class="card-body">'+
        '                                <div class="form-validation">'+
        '                                    <form class="form-valide" action="/updateRoomName" method="post">'+
        '                                        <div class="form-group row">'+
        '                                            <label class="col-lg-4 col-form-label" for="val-username">Provider <span class="text-danger">*</span></label>'+
        '                                            <div class="col-lg-6">'+
        '                                                <input type="text" class="form-control" id="provider" value='+element.provider+' name="provider" placeholder="Enter a provider..">'+
        //'                                    <input type="hidden" name="_id" value="'+element._id+'">'
        '                                            </div>'+
        '                                        </div>'+
        ''+
        '                                        <div class="form-group row">'+
        '                                            <label class="col-lg-4 col-form-label" for="val-password">Location <span class="text-danger">*</span></label>'+
        '                                            <div class="col-lg-6">'+
        '                                                <input type="text" class="form-control" id="rLocation" value='+element.data[0].roomLocation+' name="rLocation" placeholder="Choose a safe one..">'+
        '                                            </div>'+
        '                                        </div>'+
        '                                        <div class="form-group row">'+
        '                                            <label class="col-lg-4 col-form-label" for="val-password">room Number <span class="text-danger">*</span></label>'+
        '                                            <div class="col-lg-6">'+
        '                                                <input type="text" class="form-control" id="roomNumber" value='+element.data[0].roomNumber+' name="roomNumber" placeholder="Choose a safe one..">'+
        '                                            </div>'+
        '                                        </div>'+
        '                                        <div class="form-group row">'+
        '                                            <label class="col-lg-4 col-form-label" for="val-password"><span class="text-danger"></span></label>'+
        '                                            <div class="col-lg-6">'+
        '                                                <input type="hidden" class="form-control" id="_id" value='+element._id+' name="_id">'+
        '                                            </div>'+
        '                                        </div>'+
        '                                        <div class="form-group row">'+
